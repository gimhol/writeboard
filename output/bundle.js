(function () {
    ...
    class ShapeData {
        ...
        set rotation(v) { this.r = Degrees.normalized(v); }
        merge(o) {
            this.read(o);
            return this;
        }
    ...
    class PenTool {
        ...
        pointerUp(dot) {
            ...
            (_a = this._board) === null || _a === void 0 ? void 0 : _a.emitEvent(EventEnum.ShapesDone, {
    ...
    ***************************************************************************** */
    ...
    class SelectorTool {
        ...
        getReiszerCursor(direction, shape) {
            ...
            if (!direction)
                return 'move';
            const deg = Math.floor((25 + Degrees.angle(Degrees.normalized(rotation + (direction - 1) * Math.PI * 0.25))) / 45) % 8;
            switch (deg) {
                case 0:
    ...
    var Gim = /*#__PURE__*/Object.freeze({
        __proto__: null,
        ActionQueue: ActionQueue,
        get Arrays () { return Arrays; },
        BinaryRange: BinaryRange,
        BinaryTree: BinaryTree,
        Board: Board,
        get ChangeType () { return ChangeType; },
        CrossData: CrossData,
        CrossTool: SimpleTool,
        DefaultFactory: DefaultFactory,
        DefaultShapeDecoration: DefaultShapeDecoration,
        DefaultShapesMgr: DefaultShapesMgr,
        get Degrees () { return Degrees; },
        get EventEnum () { return EventEnum; },
        get Events () { return Events; },
        FClipboard: FClipboard,
        get FactoryEnum () { return FactoryEnum; },
        get FontFamilysChecker () { return FontFamilysChecker; },
        Gaia: Gaia,
        HalfTickData: HalfTickData,
        HalfTickTool: SimpleTool,
        ImgData: ImgData,
        ...
        get ObjectFit () { return ObjectFit; },
        OvalData: OvalData,
        OvalTool: OvalTool,
        PenData: PenData,
        PenTool: PenTool,
        ...
        get ResizeDirection () { return ResizeDirection; },
        RotatedRect: RotatedRect,
        get SelectorStatus () { return SelectorStatus; },
        SelectorTool: SelectorTool,
        Shape: Shape,
        ShapeCross: ShapeCross,
        ShapeData: ShapeData,
        get ShapeEnum () { return ShapeEnum; },
        ShapeHalfTick: ShapeHalfTick,
        ShapeImg: ShapeImg,
        ShapeLines: ShapeLines,
        ShapeNeedPath: ShapeNeedPath,
        ShapeOval: ShapeOval,
        ShapePen: ShapePen,
        ...
        TickData: TickData,
        TickTool: SimpleTool,
        get ToolEnum () { return ToolEnum; },
        Vector: Vector,
        builtInFontFamilies: builtInFontFamilies,
        builtInFontNames: builtInFontNames,
    ...
    class Styles {
        ...
        register(name, style) {
            ...
            if (style) {
                ...
                processed = reValue(style, existed !== null && existed !== void 0 ? existed : {});
            }
    ...
    })(DockableEventType || (DockableEventType = {}));
    ...
    class View {
        ...
        get hoverOb() {
            var _a;
            this._hoverOb = (_a = this._hoverOb) !== null && _a !== void 0 ? _a : new HoverOb(this.inner).setCallback(v => this.onHover(v));
            return this._hoverOb;
        }
        get focused() { return this.focusOb.focused; }
        get focusOb() {
            var _a;
            this._focusOb = (_a = this._focusOb) !== null && _a !== void 0 ? _a : new FocusOb(this.inner, v => this.onFocus(v));
            return this._focusOb;
        }
        get styles() {
            var _a;
            this._styles = (_a = this._styles) !== null && _a !== void 0 ? _a : new Styles(this);
            return this._styles;
        }
    ...
    class Menu extends View {
        ...
        setup(items) {
            ...
            this._items = items.map(info => {
                var _a;
                this._onitemclick = () => {
                    this.dispatchEvent(new CustomEvent(MenuEventType.ItemClick, { detail: info }));
                    this.hide();
                };
                this._onsubmenuitemclick = (e) => {
                    this.dispatchEvent(new CustomEvent(MenuEventType.ItemClick, { detail: e.detail }));
                    this.hide();
                };
    ...
    })(ButtonGroupMode || (ButtonGroupMode = {}));
    class ButtonGroup {
    ...
    View.get(document.head).addChild(new View('title', '每日一句'), new View('link')
        .setAttribute('rel', 'icon')
        .setAttribute('sizes', '16x16')
        .setAttribute('href', './calendar_phrases/logo.png'));
    Styles.css('./calendar_phrases/styles/index.css', './calendar_phrases/styles/edit_panel.css').then(() => main());
    function main() {
        ...
        const mainView = View.ref();
        const blackboard = View.ref();
        View.get(document.body)
            .ref(mainView)
            .styles
            .addCls('g_cp_main_view')
            .view
            .addChild(View.get('div')
        ...
        Gaia.editToolInfo(ToolEnum.Cross, v => (Object.assign(Object.assign({}, v), { name: '打叉' })));
        Gaia.editToolInfo(ToolEnum.HalfTick, v => (Object.assign(Object.assign({}, v), { name: '半对' })));
        Gaia.editToolInfo(ToolEnum.Img, v => (Object.assign(Object.assign({}, v), { name: '图片' })));
        Gaia.editToolInfo(ToolEnum.Lines, v => (Object.assign(Object.assign({}, v), { name: '直线' })));
        Gaia.editToolInfo(ToolEnum.Oval, v => (Object.assign(Object.assign({}, v), { name: '椭圆' })));
        Gaia.editToolInfo(ToolEnum.Pen, v => (Object.assign(Object.assign({}, v), { name: '笔' })));
        Gaia.editToolInfo(ToolEnum.Polygon, v => (Object.assign(Object.assign({}, v), { name: '多边形' })));
        Gaia.editToolInfo(ToolEnum.Rect, v => (Object.assign(Object.assign({}, v), { name: '矩形' })));
        Gaia.editToolInfo(ToolEnum.Selector, v => (Object.assign(Object.assign({}, v), { name: '选择器' })));
        Gaia.editToolInfo(ToolEnum.Text, v => (Object.assign(Object.assign({}, v), { name: '文本' })));
        Gaia.editToolInfo(ToolEnum.Tick, v => (Object.assign(Object.assign({}, v), { name: '打钩' })));
        const menu = new Menu(mainView.current).setup([{
                label: '工具',
                items: Gaia.listTools()
                    .filter(v => v !== ToolEnum.Img && v !== ToolEnum.Polygon)
                    .map(v => { var _a, _b; return ({ key: v, label: (_b = (_a = Gaia.toolInfo(v)) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : v }); })
            }, {
                divider: true
            }, {
                ...
                case MenuKey.InsertImage: {
                    ...
                    input.onchange = () => {
                        ...
                        for (let i = 0; i < files.length; ++i) {
                            ...
                            img.onload = () => {
                                const shape = board.factory.newShape(ShapeEnum.Img);
        ...
        const updateEditPanel = () => {
            ...
            board.selects.forEach(shape => {
                ...
                if (shape.data.needStroke) {
                    shape.data.lineWidth;
                }
                if (shape.data.type === ShapeEnum.Text) {
                    shape.data.font_size;
                }
            });
        ...
        const init = (ttt) => {
            ...
            const img_main = ((_a = board.find('img_header')) !== null && _a !== void 0 ? _a : board.factory.newShape(ShapeEnum.Img));
            ...
            const img_logo = ((_b = board.find('img_logo')) !== null && _b !== void 0 ? _b : board.factory.newShape(ShapeEnum.Img));
            ...
            const txt_main = ((_c = board.find('txt_content')) !== null && _c !== void 0 ? _c : board.factory.newShape(ShapeEnum.Text));
            ...
            const now = new Date();
            const txt_date = ((_d = board.find('txt_date')) !== null && _d !== void 0 ? _d : board.factory.newShape(ShapeEnum.Text));
            ...
            const txt_week_and_year = ((_e = board.find('txt_week_and_year')) !== null && _e !== void 0 ? _e : board.factory.newShape(ShapeEnum.Text));
        ...
        const templateText = board.factory.shapeTemplate(ShapeEnum.Text);
