    ...
    constructor(inits) {
        ...
        this._handleClick = (target) => {
            ...
            this._wins.forEach((win, idx, arr) => {
                var _a, _b, _c, _d;
                win.styleHolder().applyStyle('in_workspace', v => (Object.assign(Object.assign({}, v), { zIndex: `${this._zIndex + idx}` })));
                if (idx < arr.length - 1) {
                    const style = {
                        opacity: '0.8'
                    };
                    win.header.styleHolder().applyStyle('not_top_in_workspace', style);
                    (_a = win.content) === null || _a === void 0 ? void 0 : _a.styleHolder().applyStyle('not_top_in_workspace', style);
                    (_b = win.footer) === null || _b === void 0 ? void 0 : _b.styleHolder().applyStyle('not_top_in_workspace', style);
                }
                else {
                    win.header.styleHolder().forgoStyle('not_top_in_workspace');
                    (_c = win.content) === null || _c === void 0 ? void 0 : _c.styleHolder().forgoStyle('not_top_in_workspace');
                    (_d = win.footer) === null || _d === void 0 ? void 0 : _d.styleHolder().forgoStyle('not_top_in_workspace');
                }
            });
        };
